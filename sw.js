const CACHE_NAME = 'gohott-shell-ios-1';
const APP_SHELL = ['./', './index.html', './offline.html', './privacy.html', './terms.html', './styles.css', './mobile.css', './config.js', './native-runtime.js', './mobile.js', './observability.js', './live-look.js', './social.js', './supabase.js', './auth.js', './geo.js', './ranking.js', './map.js', './app.js', './manifest.json', './icon-192.png', './icon-512.png'];
